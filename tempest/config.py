...
HyperVOVSScenarioGroup = [
    cfg.StrOpt('image_hyperv_ref',
               help="Valid primary image reference to be used in the "
                    "test Hyper-V OVS network. This is a required option."),
    cfg.StrOpt('image_hyperv_ref_alt',
               help="Valid secondary image reference to be used in the "
                    "test Hyper-V OVS network. This is a required option."),
    cfg.StrOpt('flavor_hyperv_ref',
               default='2',
               help="Valid flavor to be used for the test Hyper-V OVS"),
    cfg.StrOpt('win_user',
    ...
    cfg.StrOpt('image_ssh_user',
               default='ssh_user',
               help="SSH user for linux image"),
    cfg.StrOpt('image_alt_ssh_user',
               default='alt_ssh_user',
               help="Alternage ssh user for alternate linux image"),
    cfg.StrOpt('ssh_timeout',
               default='300',
               help="Timeout for ssh connection"),
